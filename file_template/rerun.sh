...
echo "${mail_body}" | mailx -s "RESTART SIMULATION <${SIM_NAME}> (PID $$$$)" y.hu@mpie.de
...
echo "${mail_body}" | mailx -s "DONE RESTART SIMULATION <${SIM_NAME}> (PID $$$$)" y.hu@mpie.de
